...
function render(variables = {}) {
    ...
    // Quitado el toda la parte del card y agreado al index.html de esta forma sólo envía al html la creación del card profile
    // Se puede como estaba el archivo anteriormente en el app copy.js
